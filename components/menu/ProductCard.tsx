        ...
        <div className="flex h-full flex-col gap-4 p-4 sm:gap-5 sm:p-5 lg:gap-6 lg:p-6">
          ...
          <div className="grid grid-cols-[96px_minmax(0,1fr)_minmax(0,1.15fr)] items-stretch gap-2.5 sm:grid-cols-[110px_minmax(0,1fr)_minmax(0,1.1fr)] sm:gap-3 lg:grid-cols-[124px_minmax(0,1fr)_minmax(0,1.05fr)] lg:gap-4">
            ...
            <button
              type="button"
              onClick={() => setDetailsOpen(true)}
              className="inline-flex min-h-[56px] items-center justify-center rounded-[20px] border border-slate-200 bg-white px-3 py-3 text-[12px] font-semibold uppercase tracking-[0.2em] text-slate-500 transition hover:border-slate-300 hover:text-slate-800 sm:min-h-[58px] sm:px-4 sm:text-[12.5px] lg:min-h-[60px]"
            >
              View more
            </button>

            <button
              className="inline-flex min-h-[56px] items-center justify-center whitespace-nowrap rounded-[20px] border border-emerald-200/90 bg-[linear-gradient(180deg,#f3fbf4_0%,#eaf7ec_100%)] px-3 py-3 text-[0.9rem] font-medium text-emerald-800 shadow-sm transition hover:border-emerald-300 hover:bg-emerald-50 disabled:cursor-not-allowed disabled:opacity-80 sm:min-h-[58px] sm:px-4 sm:text-[0.96rem] lg:min-h-[60px] lg:text-[1rem]"
              onClick={addToCart}
