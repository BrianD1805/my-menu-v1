          ...
          <div className="grid grid-cols-[8.25rem_minmax(0,1fr)] items-center gap-4 sm:grid-cols-[9.5rem_minmax(0,1fr)] sm:gap-5 lg:grid-cols-[10.5rem_minmax(0,1fr)] lg:gap-6">
            ...
            <div className="min-w-0">
              <button type="button" onClick={() => setDetailsOpen(true)} className="block min-w-0 text-left">
                <h3 className="text-[1.1rem] font-semibold leading-[1.18] tracking-tight text-slate-950 sm:text-[1.32rem] lg:text-[1.275rem] xl:text-[1.36rem]">
                  <span>{name}</span>
                  <span className="ml-1.5 hidden align-middle text-slate-500 lg:inline-block" aria-hidden="true">
                    <svg viewBox="0 0 24 24" className="inline-block h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M7 17L17 7" />
                      <path d="M8 7h9v9" />
                    </svg>
                  </span>
