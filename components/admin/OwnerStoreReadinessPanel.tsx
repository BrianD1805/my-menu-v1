...
function trialPillClasses(trial: TrialState) {
  ...
  if ((trial.trialDaysRemaining ?? 99) <= 2)
    return "bg-[#FFF7F0] text-[#9A3412] ring-1 ring-[#FF6A3D]/25";
  return "bg-emerald-50 text-emerald-800 ring-1 ring-emerald-200";
}
...
export default function OwnerStoreReadinessPanel() {
  ...
  const summaryCards = [
    ...
    },
    {
      ...
      className: "border-[#FFB168]/35 bg-[#FFB168]/10 text-[#FFE1C7]",
    },
    {
      ...
      hint: "2 days or less",
      className: "border-orange-300/35 bg-orange-400/10 text-orange-50",
    },
    {
    ...
    },
    {
      ...
      className: "border-[#FFB168]/35 bg-white/10 text-[#FFE1C7]",
    },
  ];
  ...
  return (
    <section className="overflow-hidden rounded-[30px] border border-[#0E0E10]/10 bg-white shadow-[0_18px_50px_rgba(14,14,16,0.08)]">
            ...
            return (
              <button
                ...
                className={[
                  ...
                  card.className,
                  selected
                    ? "ring-2 ring-[#FFB168] ring-offset-2 ring-offset-[#0E0E10]"
                    : "",
                ].join(" ")}
      ...
      <div className="border-t border-[#0E0E10]/10 p-5 sm:p-6">
        {message ? (
          <p className="mb-4 rounded-2xl border border-[#FF6A3D]/20 bg-[#FFF7F0] px-4 py-3 text-sm font-bold text-[#C84F2A]">
            {message}
          </p>
        ) : null}
        <div className="mb-4 flex flex-col gap-3 rounded-[24px] border border-[#0E0E10]/8 bg-[#FFF7F0] p-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.18em] text-[#C84F2A]">
              Selected view
            </p>
            <h3 className="mt-1 text-xl font-black text-[#0E0E10]">
          ...
          {activeFilter !== "all" ? (
            <button
              ...
              className="inline-flex min-h-10 items-center justify-center rounded-2xl border border-[#0E0E10]/10 bg-white px-4 py-2 text-xs font-black text-[#0E0E10] transition hover:bg-[#FFF7F0]"
            >
              Show all stores
            </button>
          ) : null}
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="inline-flex min-h-10 items-center justify-center rounded-2xl bg-red-700 px-4 py-2 text-xs font-black text-white transition hover:bg-red-800 disabled:cursor-not-allowed disabled:opacity-45"
              >
              ...
              {selectedDeleteIds.length ? (
                <button
                  ...
                  className="inline-flex min-h-10 items-center justify-center rounded-2xl border border-red-200 bg-white px-4 py-2 text-xs font-black text-red-800 transition hover:bg-red-50"
                >
                  Clear selection
                </button>
              ) : null}
        ...
        {!loading && stores.length === 0 ? (
          <div className="rounded-[24px] border border-dashed border-[#0E0E10]/18 bg-[#FFF7F0] p-5 text-sm leading-6 text-[#5C5F66]">
              ...
              >
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                  <div className="flex min-w-0 flex-1 gap-3">
                    <label
                      className="mt-1 inline-flex h-11 w-11 shrink-0 cursor-pointer items-center justify-center rounded-2xl border border-[#0E0E10]/10 bg-white shadow-sm transition hover:bg-[#FFF7F0]"
                    ...
                    <div className="min-w-0">
                      <div className="flex flex-wrap items-center gap-2">
                        <h3 className="text-lg font-black text-[#0E0E10]">
                          {store.name}
                        </h3>
                        <span
                          className={[
                        ...
                        store.trial.isTrialExpired ? (
                          <span className="rounded-full bg-red-50 px-3 py-1 text-[11px] font-black uppercase tracking-[0.14em] text-red-800 ring-1 ring-red-200">
                            Checkout paused
                          </span>
                        ) : null}
                        {(store.referral?.stats?.referredCount || 0) > 0 ? (
                          <span className="rounded-full bg-[#FFF7F0] px-3 py-1 text-[11px] font-black uppercase tracking-[0.14em] text-[#9A3412] ring-1 ring-[#FF6A3D]/25">
                        ...
                        {store.referral?.referredBy ? (
                          <span className="rounded-full bg-blue-50 px-3 py-1 text-[11px] font-black uppercase tracking-[0.14em] text-blue-800 ring-1 ring-blue-200">
                            Referred
                          </span>
                        ) : null}
                      </div>
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="mt-1 block break-all text-sm font-bold text-[#C84F2A] hover:text-[#0E0E10]"
                      >
                        {store.storeAddress}
                      </a>
                  ...
                  <div className="min-w-[160px]">
                    <div className="h-3 overflow-hidden rounded-full bg-[#0E0E10]/10">
                      <div
                        className="h-full rounded-full bg-[#FF6A3D]"
                        style={{
                          width: `${Math.max(4, Math.min(100, store.readiness.score))}%`,
                        }}
                      />
                    </div>
                    <p className="mt-2 text-right text-xs font-black text-[#0E0E10]">
                ...
                <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:flex-wrap">
                  ...
                  <button
                    ...
                    className="inline-flex min-h-10 items-center justify-center rounded-2xl border border-[#FF6A3D]/25 bg-[#FFF7F0] px-4 py-2 text-xs font-black text-[#9A3412] transition hover:bg-white disabled:cursor-not-allowed disabled:opacity-60"
                  >
                  ...
                  <button
                    ...
                    disabled={extendBusyId === store.id}
                    className="inline-flex min-h-10 items-center justify-center rounded-2xl border border-[#0E0E10]/10 bg-white px-4 py-2 text-xs font-black text-[#0E0E10] transition hover:bg-[#FFF7F0] disabled:cursor-not-allowed disabled:opacity-60"
                  >
                    +1 day
                  </button>
                  <button
        ...
        >
          <div className="max-h-[90vh] w-full max-w-2xl overflow-hidden rounded-[32px] border border-red-200 bg-white shadow-[0_30px_100px_rgba(0,0,0,0.35)]">
            ...
            <div className="max-h-[58vh] overflow-y-auto px-5 py-5 sm:px-6">
              <p className="text-sm font-black text-[#0E0E10]">
              ...
              <div className="mt-3 space-y-2">
                {selectedDeleteStores.map((store) => (
                  ...
                  >
                    <p className="font-black text-red-950">{store.name}</p>
              ...
              <label className="mt-5 block text-sm font-black text-[#0E0E10]">
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-2xl border border-[#0E0E10]/12 bg-white px-4 py-3 text-sm font-black tracking-[0.08em] text-[#0E0E10] outline-none transition focus:border-red-500 focus:ring-4 focus:ring-red-100"
            ...
            <div className="flex flex-col gap-2 border-t border-[#0E0E10]/10 bg-[#FFF7F0] px-5 py-4 sm:flex-row sm:justify-end sm:px-6">
              <button
                type="button"
                onClick={() => {
                  setDeleteDialogOpen(false);
                ...
                disabled={deleteBusy}
                className="inline-flex min-h-11 items-center justify-center rounded-2xl border border-[#0E0E10]/10 bg-white px-5 py-3 text-sm font-black text-[#0E0E10] transition hover:bg-[#F5F2EE] disabled:opacity-60"
              >
                Cancel
              </button>
              <button
                ...
                className="inline-flex min-h-11 items-center justify-center rounded-2xl bg-red-700 px-5 py-3 text-sm font-black text-white transition hover:bg-red-800 disabled:cursor-not-allowed disabled:opacity-45"
              >
                {deleteBusy
                  ? "Deleting..."
