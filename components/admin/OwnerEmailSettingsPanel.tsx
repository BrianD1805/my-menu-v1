  ...
  return (
    <section className="mt-8 overflow-hidden rounded-[30px] border border-[#0E0E10]/10 bg-white shadow-[0_20px_60px_rgba(14,14,16,0.08)]">
      ...
      {platformMode && !ownerGateUnlocked ? (
        <div className="border-b border-[#0E0E10]/10 bg-[#F3F7FA] px-5 py-5 sm:px-6">
          <label
            className="block text-sm font-semibold text-[#0E0E10]"
          ...
          <div className="mt-3 flex flex-col gap-3 sm:flex-row">
            <input
              ...
              className="min-h-12 flex-1 rounded-2xl border border-[#0E0E10]/15 bg-white px-4 text-sm font-semibold text-[#0E0E10] outline-none transition focus:border-[#336699]"
            />
            <button
              type="button"
              onClick={loadStatus}
              disabled={loading}
              className="inline-flex min-h-12 items-center justify-center rounded-2xl bg-[#0E0E10] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#252528] disabled:cursor-not-allowed disabled:opacity-55"
            >
      ...
      <div className="grid gap-5 p-5 sm:p-6 lg:grid-cols-[1fr_1fr]">
        <div className="rounded-[24px] border border-[#0E0E10]/10 bg-[#F3F7FA] p-4">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#28547D]">
            Runtime status
          </p>
          {loading ? (
        ...
        <form
          onSubmit={sendTest}
          className="rounded-[24px] border border-[#336699]/20 bg-white p-4 shadow-[0_14px_38px_rgba(14,14,16,0.05)]"
        >
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#28547D]">
            Send live test
          </p>
          <label
            className="mt-4 block text-sm font-semibold text-[#0E0E10]"
          ...
          <input
            ...
            className="mt-2 min-h-12 w-full rounded-2xl border border-[#0E0E10]/15 bg-[#F3F7FA] px-4 text-sm font-semibold text-[#0E0E10] outline-none transition focus:border-[#336699] focus:bg-white"
          />
          <p className="mt-2 text-xs leading-5 text-[#68707A]">
          ...
          <button
            ...
            className="admin-pressable mt-4 inline-flex min-h-12 w-full items-center justify-center rounded-2xl bg-[#336699] px-5 py-3 text-sm font-semibold text-white shadow-[0_16px_36px_rgba(51,102,153,0.22)] transition hover:-translate-y-[1px] hover:bg-[#28547D] disabled:cursor-not-allowed disabled:opacity-55"
          >
      ...
      <div className="border-t border-[#0E0E10]/10 bg-[#F3F7FA] px-5 py-4 text-xs leading-5 text-[#5C5F66] sm:px-6">
        Required Netlify variables:{" "}
        <span className="font-semibold text-[#0E0E10]">RESEND_API_KEY</span>,{" "}
        <span className="font-semibold text-[#0E0E10]">ORDUVA_EMAIL_FROM</span>,
        and{" "}
        <span className="font-semibold text-[#0E0E10]">ORDUVA_OWNER_EMAIL</span>.
