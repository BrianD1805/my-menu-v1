const STORE_CACHE = 'orduva-storefront-runtime-ver-0-187b';
const STATIC_CACHE = 'orduva-storefront-static-ver-0-187b';
const PAGE_CACHE = 'orduva-storefront-pages-ver-0-187b';
...
self.addEventListener('fetch', (event) => {
  ...
  // Ver-0.187B: do not let the storefront PWA cache/session shell touch
