        ...
        <header className="rounded-[34px] border border-[#0E0E10]/10 bg-gradient-to-br from-[#0E0E10] via-[#102338] to-[#336699] p-5 text-white shadow-[0_28px_80px_rgba(14,14,16,0.16)] sm:p-7">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="mt-1 text-2xl font-semibold tracking-tight text-white sm:text-4xl">Referrals</h1>
            </div>
          </div>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <div className="inline-flex rounded-full border border-[#339933]/25 bg-[#339933]/14 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#DDFBE4]">Payment event ledger</div>
          </div>
        </header>
