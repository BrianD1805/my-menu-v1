    ...
    <main className="min-h-screen bg-[#FFF7F0] px-4 py-5 text-[#1F2328] sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        <header className="rounded-[34px] border border-[#0E0E10]/10 bg-white/90 p-5 shadow-[0_28px_80px_rgba(14,14,16,0.12)] backdrop-blur sm:p-7">
          <p className="text-xs font-black uppercase tracking-[0.24em] text-[#FF6A3D]">Stripe billing</p>
          <h1 className="mt-2 text-2xl font-black tracking-tight text-[#0E0E10] sm:text-4xl">Stripe price ID configuration</h1>
          ...
          <div className="mt-4 inline-flex rounded-full border border-[#0E0E10]/10 bg-[#FFF7F0] px-3 py-1.5 text-[11px] font-black uppercase tracking-[0.18em] text-[#5C5F66]">
            {LIVE_VERSION}
          </div>
        </header>
