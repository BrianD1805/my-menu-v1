      ...
      <div className="mx-auto max-w-6xl">
        <header className="rounded-[34px] border border-[#0E0E10]/10 bg-white/90 p-5 shadow-[0_28px_80px_rgba(14,14,16,0.12)] backdrop-blur sm:p-7">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <h1 className="mt-1 text-2xl font-black tracking-tight text-[#0E0E10] sm:text-4xl">Affiliates</h1>
              </div>
            </div>
            <div className="flex flex-wrap gap-2.5">
              <Link href="/platform" className="inline-flex min-h-11 items-center justify-center rounded-2xl border border-[#0E0E10]/10 bg-white px-5 py-3 text-sm font-bold text-[#0E0E10] transition hover:bg-[#F5F2EE]">Dashboard</Link>
              <Link href="/platform/referrals" className="inline-flex min-h-11 items-center justify-center rounded-2xl border border-[#FF6A3D]/25 bg-[#FFF7F0] px-5 py-3 text-sm font-black text-[#9A3412] transition hover:bg-white">Tenant referrals</Link>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <div className="inline-flex rounded-full border border-[#FF6A3D]/20 bg-[#FF6A3D]/10 px-3 py-1.5 text-[11px] font-black uppercase tracking-[0.18em] text-[#C84F2A]">10% affiliate · 5% tenant source</div>
          </div>
        </header>
