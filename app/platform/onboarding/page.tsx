        ...
        <header className="rounded-[34px] border border-[#0E0E10]/10 bg-white/90 p-5 shadow-[0_28px_80px_rgba(14,14,16,0.12)] backdrop-blur sm:p-7">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="mt-1 text-2xl font-semibold tracking-tight text-[#0E0E10] sm:text-4xl">Onboarding tools</h1>
            </div>
          </div>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <div className="inline-flex rounded-full border border-[#336699]/20 bg-[#336699]/10 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#336699]">Owner onboarding</div>
          </div>
        </header>
        <div className="mt-6"><div className="space-y-6">
