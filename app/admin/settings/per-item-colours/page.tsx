...
export default async function AdminSettingsPerItemColoursPage() {
  ...
  return (
    <AdminShell
      ...
      description="Edit storefront colour details with space for preview and suggested colour windows."
    ...
    >
      <TenantSettingsForm
        ...
        focusSection="per-item-storefront-colours"
        initial={{
          ...
          privacyPolicyBody: settings?.privacy_policy_body || "",
          ...
          termsOfServiceBody: settings?.terms_of_service_body || "",
          ...
          payfastPassphraseHint: payfastPassphrase
            ? `••••${payfastPassphrase.slice(-4)}`
            : "",
