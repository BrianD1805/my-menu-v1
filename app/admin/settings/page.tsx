    ...
    >
      ...
      <TenantSettingsForm
        ...
        initial={{
          ...
          currencyDisplayMode: settings?.currency_display_mode ?? (DEFAULT_MONEY_SETTINGS.currencyDisplayMode ?? "code"),
          currencySymbolPosition: settings?.currency_symbol_position ?? (DEFAULT_MONEY_SETTINGS.currencySymbolPosition ?? "before"),
          currencyDecimalPlaces: String(settings?.currency_decimal_places ?? DEFAULT_MONEY_SETTINGS.currencyDecimalPlaces ?? 0),
          currencyUseThousandsSeparator: settings?.currency_use_thousands_separator ?? DEFAULT_MONEY_SETTINGS.currencyUseThousandsSeparator ?? true,
