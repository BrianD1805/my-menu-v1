...
export type TenantSettings = {
  ...
  payfast_merchant_key_set?: boolean | null;
  payfast_merchant_key_hint?: string | null;
  payfast_passphrase_set?: boolean | null;
  payfast_passphrase_hint?: string | null;
...
export async function getTenantSettings(
  ...
  return {
    ...
    enable_payfast_customer_payments: asBooleanOrNull(
      (data as Record<string, unknown>).enable_payfast_customer_payments,
    ),
    payfast_connection_status: asStringOrNull(
      (data as Record<string, unknown>).payfast_connection_status,
    ),
    payfast_customer_mode: asStringOrNull(
      (data as Record<string, unknown>).payfast_customer_mode,
    ),
    payfast_merchant_id: asStringOrNull(
      (data as Record<string, unknown>).payfast_merchant_id,
    ),
    payfast_account_label: asStringOrNull(
      (data as Record<string, unknown>).payfast_account_label,
    ),
    payfast_setup_notes: asStringOrNull(
      (data as Record<string, unknown>).payfast_setup_notes,
    ),
    payfast_payments_live: asBooleanOrNull(
      (data as Record<string, unknown>).payfast_payments_live,
    ),
