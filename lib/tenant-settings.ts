...
export async function getTenantSettings(tenantId: string): Promise<TenantSettings | null> {
  ...
  return {
    ...
    yoco_customer_mode: asStringOrNull((data as Record<string, unknown>).yoco_customer_mode),
    yoco_customer_account_label: asStringOrNull((data as Record<string, unknown>).yoco_customer_account_label),
    yoco_customer_setup_notes: asStringOrNull((data as Record<string, unknown>).yoco_customer_setup_notes),
    yoco_customer_webhook_id: asStringOrNull((data as Record<string, unknown>).yoco_customer_webhook_id),
    yoco_customer_webhook_url: asStringOrNull((data as Record<string, unknown>).yoco_customer_webhook_url),
    ...
    mpesa_customer_mode: asStringOrNull((data as Record<string, unknown>).mpesa_customer_mode),
    mpesa_customer_consumer_key: asStringOrNull((data as Record<string, unknown>).mpesa_customer_consumer_key),
    mpesa_customer_ipn_id: asStringOrNull((data as Record<string, unknown>).mpesa_customer_ipn_id),
    mpesa_customer_account_label: asStringOrNull((data as Record<string, unknown>).mpesa_customer_account_label),
    mpesa_customer_setup_notes: asStringOrNull((data as Record<string, unknown>).mpesa_customer_setup_notes),
    mpesa_customer_payments_live: asBooleanOrNull((data as Record<string, unknown>).mpesa_customer_payments_live),
    enable_daraja_customer_payments: asBooleanOrNull((data as Record<string, unknown>).enable_daraja_customer_payments),
    daraja_connection_status: asStringOrNull((data as Record<string, unknown>).daraja_connection_status),
    daraja_customer_mode: asStringOrNull((data as Record<string, unknown>).daraja_customer_mode),
    daraja_consumer_key: asStringOrNull((data as Record<string, unknown>).daraja_consumer_key),
    daraja_shortcode: asStringOrNull((data as Record<string, unknown>).daraja_shortcode),
    daraja_transaction_type: asStringOrNull((data as Record<string, unknown>).daraja_transaction_type),
    daraja_account_reference_prefix: asStringOrNull((data as Record<string, unknown>).daraja_account_reference_prefix),
    daraja_callback_url: asStringOrNull((data as Record<string, unknown>).daraja_callback_url),
    daraja_account_label: asStringOrNull((data as Record<string, unknown>).daraja_account_label),
    daraja_setup_notes: asStringOrNull((data as Record<string, unknown>).daraja_setup_notes),
    daraja_payments_live: asBooleanOrNull((data as Record<string, unknown>).daraja_payments_live),
    rewards_enabled: asBooleanOrNull((data as Record<string, unknown>).rewards_enabled),
    rewards_program_name: asStringOrNull((data as Record<string, unknown>).rewards_program_name),
    rewards_silver_min_spend: asNumberOrNull((data as Record<string, unknown>).rewards_silver_min_spend),
    rewards_silver_discount_percent: asNumberOrNull((data as Record<string, unknown>).rewards_silver_discount_percent),
    rewards_gold_min_spend: asNumberOrNull((data as Record<string, unknown>).rewards_gold_min_spend),
    rewards_gold_discount_percent: asNumberOrNull((data as Record<string, unknown>).rewards_gold_discount_percent),
    rewards_platinum_min_spend: asNumberOrNull((data as Record<string, unknown>).rewards_platinum_min_spend),
    rewards_platinum_discount_percent: asNumberOrNull((data as Record<string, unknown>).rewards_platinum_discount_percent),
    discounts_enabled: asBooleanOrNull((data as Record<string, unknown>).discounts_enabled),
    discount_popup_enabled: asBooleanOrNull((data as Record<string, unknown>).discount_popup_enabled),
    ...
    receipt_tax_rate_percent: asNumberOrNull((data as Record<string, unknown>).receipt_tax_rate_percent),
    ...
    seo_page_name: asStringOrNull((data as Record<string, unknown>).seo_page_name),
    seo_meta_description: asStringOrNull((data as Record<string, unknown>).seo_meta_description),
    seo_keywords: asStringOrNull((data as Record<string, unknown>).seo_keywords),
    seo_canonical_url: asStringOrNull((data as Record<string, unknown>).seo_canonical_url),
    seo_structured_data_enabled: asBooleanOrNull((data as Record<string, unknown>).seo_structured_data_enabled),
    google_tracking_id: asStringOrNull((data as Record<string, unknown>).google_tracking_id),
    google_tag_manager_id: asStringOrNull((data as Record<string, unknown>).google_tag_manager_id),
    invoice_payments_enabled: asBooleanOrNull((data as Record<string, unknown>).invoice_payments_enabled),
    invoice_payments_section_title: asStringOrNull((data as Record<string, unknown>).invoice_payments_section_title),
    invoice_payments_intro_text: asStringOrNull((data as Record<string, unknown>).invoice_payments_intro_text),
  };
}
