...
## Ver-0.114A
- Rebuilt the mobile-only category carousel cleanly from the 0.113 baseline.
- Keeps the existing product card styling intact.
- Shows one full centred card at a time with controlled swipe and subtle premium navigation.
- Desktop remains unchanged.


## Ver-0.114B
- Removed the left and right arrow buttons from the mobile category carousel.
- Swipe interaction remains intact.
